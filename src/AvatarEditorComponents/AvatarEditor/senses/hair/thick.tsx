    ...
    return (
        ...
        >
            <path
                ...
                strokeWidth="3"
            />
            <path d="M205.134 124.947L189.316 71.5069L199.354 62.3644C210.109 99.4523 210.601 120.988 205.134 124.947Z" fill={colorRandom ? color : 'black'} stroke="black" strokeWidth="3" />
            <path
            ...
            <path
                ...
                strokeWidth="3"
            />
            <path d="M10 84.4996C21.6 77.6996 32.8333 79.9996 37 81.9996L32.5 97.5C31.3 89.1 17 85.3331 10 84.4996Z" fill={colorRandom ? color : 'black'} stroke="black" strokeWidth="3" />
        </svg>
    );
}
